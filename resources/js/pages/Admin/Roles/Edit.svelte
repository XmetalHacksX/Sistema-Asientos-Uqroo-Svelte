...
<script lang="ts">
    ...
    let { role, permissions, rolePermissions } = $props();
...
<AppHead title={`Editar Rol - ${role.name}`} />

<div class="p-6">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-xl font-semibold text-foreground">Editar Rol</h1>
            <p class="text-sm text-muted-foreground">
                Modifica el nombre o actualiza los permisos del rol.
            </p>
        </div>
        <Link
            href="/admin/roles"
