...
<AppHead title="Crear Edificio" />

<div class="p-6">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-xl font-semibold text-foreground">Crear Edificio</h1>
            <p class="text-sm text-muted-foreground">Registra un nuevo edificio.</p>
        </div>
        <Link
